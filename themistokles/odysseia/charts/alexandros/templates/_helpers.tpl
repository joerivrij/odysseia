...
{{- define "periandros.uname" -}}
{{- if empty .Values.services.periandros.name -}}
{{ .Values.images.periandros }}
{{- else -}}
{{ .Values.services.periandros.name }}
{{- end -}}
{{- end -}}
...
Create the name of the service account to use
*/}}
{{- define "periandros.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- default (include "periandros.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "periandros.roleName" -}}
{{- if .Values.role.create -}}
{{- default (include "periandros.fullname" .) .Values.role.name }}
{{- else -}}
...
*/}}
{{- define "periandros.bindingName" -}}
{{- if .Values.role.create -}}
{{- default (include "periandros.fullname" .) .Values.role.name }}
{{- else -}}
    {{- default (include "periandros.roleName" .) "leaderelection-binding" }}
{{- end -}}
{{- end -}}
