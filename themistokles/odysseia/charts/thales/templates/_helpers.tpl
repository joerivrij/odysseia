...
{{- define "job.uname" -}}
{{- if empty .Values.services.job.name -}}
{{ .Values.images.job }}
{{- else -}}
{{ .Chart.Name }}
{{- end -}}
...
{{- define "jobinit.uname" -}}
{{- if empty .Values.services.jobinit.name -}}
{{ .Values.images.jobinit }}
{{- else -}}
{{ .Values.services.jobinit.name }}
{{- end -}}
{{- end -}}
