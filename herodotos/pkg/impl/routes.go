...
func InitRoutes(config config.HerodotosConfig) *mux.Router {
	...
	serveMux.HandleFunc("/herodotos/v1/health", middleware.Adapt(herodotosHandler.pingPong, middleware.ValidateRestMethod("GET"), middleware.LogRequestDetails(), middleware.SetCorsHeaders()))
