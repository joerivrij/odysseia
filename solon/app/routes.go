...
func InitRoutes(config SolonConfig) *mux.Router {
	...
	serveMux.HandleFunc("/solon/v1/service", middleware.Adapt(handler.RegisterService, middleware.ValidateRestMethod("POST"), middleware.LogRequestDetails(), middleware.SetCorsHeaders()))
