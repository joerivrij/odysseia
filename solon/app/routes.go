...
func InitRoutes(config SolonConfig) *mux.Router {
	...
	serveMux.HandleFunc("/solon/v1/service", middleware.Adapt(handler.RegisterService, middleware.ValidateRestMethod("GET"), middleware.LogRequestDetails(), middleware.SetCorsHeaders()))
